"""
EXPERIMENT 2 -- Model B: the headline quantum head (THE main quantum result).

Frozen Beast -> learned Linear(128,4) -> tanh*pi -> VQC(4 qubits, 5 layers,
data-reuploading RY + CNOT ring) -> Linear(4,4) readout. 556 trainable params.
Reaches ~96% and is the model compared against the classical controls C/D.
Output: results_exp3_quantum_4class_100epochs/.
"""
import sys, os
...
# ---------------------------------------------------------------------------
# Experiment 2 — multi-class hard task (4 classes drawn from confusion pairs)
# ---------------------------------------------------------------------------
CLASSES = [
    "STAR_BROWN_DWARF_L",
    "STAR_M8",
...
def main():
    ...
    results_dir = f"results_exp3_quantum_{len(CLASSES)}class_100epochs"
