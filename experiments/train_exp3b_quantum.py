...
from src.models.exp3_models import FrozenBeastVQCClassifier, FrozenBeastVQCClassifier2
...
def main():
    ...
    results_dir = f"results_exp3b_quantum_{len(CLASSES)}class"
    ...
    model = FrozenBeastVQCClassifier2(
    ...
    trainer = SDSSPerformanceTrainer(model, training_config, run_name="Exp3Quantum_V3b")
